...
<body style="background-color: #8791c8">
            ...
            <div class="col-md-12">
                ...
                <?php
                    ...
                    if(@$_GET['q']== 'result' && @$_GET['eid']) 
                    {
                        ...
                        echo '</table><button class="btn btn-primary"><span aria-hidden="true"></span><a href="welcome.php?q=1" style="color:white;text-decoration:none;">Go to Home Page</a></button></div>';
